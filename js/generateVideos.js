...
async function loadVideos() {
    try {
        ...
        videos.forEach((video) => {
            ...
            <img src=${video.cover} alt="" class="video-image" />
            <div class="video-info">
                <div class="info-left">
                <span class="views-icon">
                    ${icons.viewIcon}
                </span>
                <span class="views-number">${video.views}</span>
                <span class="danmu-icon">
                    ${icons.danmuIcon}
                </span>
                <span class="danmu-number">${video.danmu_number}</span>
                </div>
            ...
            <div class="author-date">
                ...
                <div class="realease-date">· ${video.publish_time}</div>
            </div>
            </div>
            `;
